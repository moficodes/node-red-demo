...
Use Watson Visual Recognition to analyze images from tweets 

![](../.gitbook/assets/screen-shot-2019-07-16-at-6.34.54-pm.png)

![](../.gitbook/assets/node-red-twitter-tweetimageanalyzer-dashboard.png)

#### Go to Catalog on IBM Cloud and create an instance of Visual Recognition Service. Use your API keys to authenticate to this flow 
